...
icon = pygame.image.load('oi\\icon.png')
pygame.display.set_icon(icon)
fundo1 = pygame.image.load('oi\\fundo.png')
fundo0 = pygame.image.load('oi\\fundo1.png')
fundo2 = pygame.image.load('oi\\fundo2.png')
laranja = pygame.image.load('oi\\laranja.png')
policia = pygame.image.load('oi\\policia.png')
policia1 = pygame.image.load('oi\\policia.png')
verde = pygame.image.load('oi\\verde.png')
vermelho = pygame.image.load('oi\\vermelho.png')
policiaarmada = pygame.image.load('oi\\Policia Armada.png')
policiaaberta = pygame.image.load('oi\\policia_porta_aberta.png')
explosao = pygame.image.load('oi\\explosao.png')
atropelado = pygame.image.load('oi\\atropelado.png')
text = pygame.image.load('oi\\text.png')
for i in range(0,1):
    missil1 = pygame.image.load('oi\\missil1.png')
    missil2 = pygame.image.load('oi\\missil2.png')
    missil1b = pygame.image.load('oi\\missil1b.png')
    missil2b = pygame.image.load('oi\\missil2b.png')
    missil1e = pygame.image.load('oi\\missil1e.png')
    missil2e = pygame.image.load('oi\\missil2e.png')
    missil1d = pygame.image.load('oi\\missil1d.png')
    missil2d = pygame.image.load('oi\\missil2d.png')
...
for i in range(0,1):
     bl = pygame.image.load('oi\\bl.png')
     bp = pygame.image.load('oi\\bp.png')
     br = pygame.image.load('oi\\br.png')
     bt = pygame.image.load('oi\\bt.png')
     dl = pygame.image.load('oi\\dl.png')
     dp = pygame.image.load('oi\\dp.png')
     dr = pygame.image.load('oi\\dr.png')
     dt = pygame.image.load('oi\\dt.png')
     el = pygame.image.load('oi\\el.png')
     ep = pygame.image.load('oi\\ep.png')
     er = pygame.image.load('oi\\er.png')
     et = pygame.image.load('oi\\et.png')
     fl = pygame.image.load('oi\\fl.png')
     fp = pygame.image.load('oi\\fp.png')
     fr = pygame.image.load('oi\\fr.png')
     ft = pygame.image.load('oi\\ft.png')
